...
export default function Navbar() {
  ...
  // Function to handle smooth scroll and URL update
    ...
    <nav className="fixed top-0 w-full z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border">
      <div className="container mx-auto px-4 sm:px-4 lg:px-8">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <Link href="#home" className="flex items-center space-x-2" onClick={(e) => { e.preventDefault(); handleScrollTo("#home"); }}>
            <span className="text-xl font-bold text-primary">Haseeb</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link href="#contact" onClick={(e) => { e.preventDefault(); handleScrollTo("#contact"); }}>
                <Button
                  variant="default"
